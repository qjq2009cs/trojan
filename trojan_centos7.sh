...
if [ $real_addr == $local_addr ] ; then
	...
	wget https://raw.githubusercontent.com/qjq2009cs/v2ray-ws-tls/master/web.zip
    	unzip web.zip
	...
	if test -s /usr/src/trojan-cert/fullchain.cer; then
        cd /usr/src
	#wget https://github.com/qjq2009cs/trojan-1/releases/download/v1.13.0/trojan-1.13.0-linux-amd64.tar.xz
	wget https://github.com/qjq2009cs/trojan-1/releases/download/v1.14.0/trojan-1.14.0-linux-amd64.tar.xz
	tar xf trojan-1.*
	#下载trojan客户端
	wget https://raw.githubusercontent.com/qjq2009cs/trojan/master/trojan-cli.zip
